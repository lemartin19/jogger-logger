...
const google_secrets_1 = require("../google-secrets");
const CLIENT_ID = 96120;
function exchangeToken(code) {
    const urlPromise = (0, google_secrets_1.accessStravaApiSecret)().then((client_secret) => {
    ...
    return new Promise((resolve, reject) => {
        urlPromise
            .then((url) => {
            let response = '';
            const req = (0, https_1.request)(url, { method: 'POST' }, (res) => {
